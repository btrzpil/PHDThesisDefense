...
\begin{frame}{Przedwzmacniacz z wejściowym obwodem sprzęgającym AC}
    ...
    \normalsize
    \begin{itemize}
        \item Konfiguracja teleskopowej kaskody 
        \item Polaryzacja pary różnicowej w obszarze podprogowym pracy tranzystora
        \item  Skalowanie wymiarów tranzystorów z uwzględnieniem optymalizacji szumów (szumów 1/f) oraz wejściowych napięć niezrównoważenia wzmacniacza
...
\begin{frame}{Kompozycja układu testowego}
    \begin{columns}
