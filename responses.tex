...
\begin{frame}[t]
    ...
    \begin{columns}
        ...
        {\renewcommand\normalsize{\small}%
            ...
            Zgodnie z wiedzą ekspercką osoby wykonującej pomiar i jej doświadczeniem w poprzednich eksperymentach efekt na elektrodzie zerowej został \high{wytłumaczony jak efekt pracy tkanki i obserwowane sygnały}????.
