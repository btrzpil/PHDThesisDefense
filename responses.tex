...
% Rozumiem, że brak zbiorczej tabeli porównującej budzi niedosyt. O ile w przypadku szumów jest przyjety konsensus dotyczący wartości i raczej wiekszość prac operuje w podobnym przedziale (5-8 uVrms dla obu zakresów) to w przypadku wartości THD mijałoby się z celem ponieważ w literature brak danych, które byłyby porównywalne.
...
\begin{columns}
    ...
    \begin{figure}[H]
        \centering
            \includegraphics[scale = 0.5]{scripts/tranTHDAmp/tranTHDAmp_ner.pdf}
    \end{figure}   
