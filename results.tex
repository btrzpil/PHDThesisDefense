...
\begin{frame}{System pomiarowy do akwizycji sygnałów neurobiologicznych}
    \begin{columns}
        ...
        \begin{figure}[H]
            \centering 
            \includegraphics[scale=0.15]{ch6/setupIBDtot.png}  
        \end{figure}
\vspace{-2em}
\begin{columns}
    ...
    \end{columns}
        ...
        \begin{figure}[H]
            ...
            \begin{subfigure}{0.25\textwidth}
                \includegraphics[scale = 0.6]{ch6/meaLFPnexus.pdf}
                 % \vfill
             \end{subfigure}
            % \hfill
                \hspace{-2em}
             \begin{subfigure}{0.7\textwidth}
                \includegraphics[scale = 0.6]{scripts/tmp/signal_MEA_LFP_wide.pdf}
             \end{subfigure}
        \end{figure}
